// Source: https://github.com/codemirror/CodeMirror/tree/master/addon/tern/tern.js
function tern$1(CodeMirror) {
  ...
  function applyChanges(ts, changes) {
    ...
    for (var file in perFile) {
      var known = ts.docs[file], chs = perFile[file];      if (!known) { continue; }
